...
以下のブロックをそれぞれColabのセルに貼り付けて実行してください。
...
# 2. blendファイルの指定
# ==========================================
# 📝 メモ：下の「ファイル名」を0.でアップロードしたものに書き換えてください
...
# 0.アップロード → 1.Blender展開 → 2.（0.）のファイルを指定 → 3.PNGレンダリング → 4.MP4化 → 5.ダウンロード
# ↑の順にコピペすることで、google様の最高のGPUをお借りしてレンダリングが可能です。
